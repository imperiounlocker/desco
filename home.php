...
<div id="topBar" class="headertopBar fixed" style="display: flex">
	...
	<a href="#acessib-menu" title="Ativar Menu de Acessibilidade" data-disclosure aria-controls="acessib-menu" aria-expanded="false" aria-haspopup="true" hidden class="bt-acessib" tabindex="10" role="button">
		...
		<span style="margin-top: -10px;" class="icone" aria-hidden="true"><img src="images/icon_acessibilidade.svg" alt="Icone do Menu de Acessibilidade"></span>
	</a>
        ...
        <ul class="slides">
            ...
            <li>
                <a href="javascript:;" onclick="trackBradesco('Home Classic','clique banner','Dia das Mães');" rel="noopener">
                    ...
                    <img src="images/001-d.jpg" alt="#PraCegoVer: Texto: O mundo precisa das mães. E as mães, de toda empatia do mundo." class="desktop">
                    <img src="images/001-m.jpg" alt="#PraCegoVer: Texto: O mundo precisa das mães. E as mães, de toda empatia do mundo." class="mobile_banner">
                </a>
            </li>
